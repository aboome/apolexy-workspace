 ...
 * 查询筛查点详情 (pat-0007)响应
 * 查询医院详情(pat-0014)请求
 * Created by wunder on 16/9/1 10:31.
 */
public class QueryNearbyScreenDetailResponse implements Serializable {

    private static final long serialVersionUID = -9099711779407209377L;
