...
<@tabledata>
    <table class="table table-hover table-bordered table-striped table-condensed">
        <thead>
         ...
         <tbody>
             <tr><!-- 该行仅为控制隔行变色 --></tr>
             <#list adminMenuDtosList as menuList>
                 <tr>
                    ...
                    <td>
                        <a href="javascript:;" class="hospital-modify" onclick="modfiymenuin(${menuList_index})"><i class="glyphicon glyphicon-edit"></i>修改</a>
                        <a href="javascript:;" class="hospital-delete" onclick="deletemenuin(${menuList_index})"><i class="glyphicon glyphicon-trash"></i>删除</a>
                    </td>
                </tr>
             </#list>
         </tbody>
