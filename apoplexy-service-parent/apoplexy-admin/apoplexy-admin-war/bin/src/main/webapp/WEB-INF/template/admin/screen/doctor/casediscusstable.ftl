         ...
         <tbody>
             ...
             <#list casesList as cases>
                 <tr>
                    ...
                    <td>
                    	<a href="javascript:;" class="view click-view" onclick="discussDetail(${cases_index})"><i class="glyphicon glyphicon-edit"></i>点击查看</a>
                    </td>
                    <td id="readCount${cases_index}">${cases.readCount}</td> 
                    <td id="replyCount${cases_index}"><a href="javascript:;" class="view replyCount"onclick="discussReviewList(${cases_index})">${cases.replyCount}</a></td>
                    <td id="likeCount${cases_index}">${cases.likeCount}</td> 
                    <td id="collectionCount${cases_index}">${cases.collectionCount}</td> 
                    <td>
                        <a href="javascript:;" class="hospital-delete"onclick="deleteDiscuss(${cases_index})"><i class="glyphicon glyphicon-trash"></i>删除</a>
                    </td>
                </tr>
             </#list>
         </tbody>
