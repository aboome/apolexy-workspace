...
html标签定义
-->
<#assign jsPath="${adminResourcesPath}/scripts">
<#assign tempsPath="${adminResourcesPath}/temps">
...
<#macro css src>
    <link rel="stylesheet" type="text/css" href="${adminResourcesPath}/theme/css/${src}?v=${version}"/>
</#macro>
