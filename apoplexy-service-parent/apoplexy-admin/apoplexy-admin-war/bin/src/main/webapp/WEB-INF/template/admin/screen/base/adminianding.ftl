...
<div class="hospital-wrap">
    ...
    <div class="table-content">
        <div class="add-and-import">
            ...
            <button type="button" class="btn import"><i class="glyphicon glyphicon-import"></i>导入</button>
        </div>

        <div id="adminiandingdoctortable" class="hospital-table">
            
        </div>
        
        <div id="adminiandingpatienttable" class="hospital-table">
 ...
 <!-- 弹出层 -->
    <div id="deletePatientLayer" style="display:none">
        <ul class="input-group">
            <label>您确定删除此条患者端端开机动画信息吗？</label>
        </ul>
    </div>
</div>
<#macro html_foot>
    <@p.js src="base/adminiandingpage.js"/>	
</#macro>