                ...
                <li>
	                ...
	                <div class="list-item none">
	                    <#list firstMenu.secondMenuList as secondMenu>
	                        <a href="javascript:;" data-addtab="menu-data-${firstMenu.id}-${secondMenu.id}" onclick="turnPage('${ctx}/${secondMenu.menuUrl}')">${secondMenu.menuName}</a>
	                    </#list>
	                </div>
                </li>
			</#list>
        ...
        <div class="currentPosition" id="tabs">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active">
                    <a href="#tab_home" data-addtab="home" onclick="turnPage('index.html')" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true">
                        首页
                    </a>
                </li>
            </ul>
