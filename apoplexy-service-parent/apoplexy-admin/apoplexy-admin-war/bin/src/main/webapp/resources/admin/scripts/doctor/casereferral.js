...
var doctorList = function (no) {
    ...
    $("#detailLayer").load(YHu.util.ctxPath('/referral/queryReveiveList'), {recordId : referralValue,pageNum : pageNum,pageSize : pageSize},function () {
...
var doctorEvaluate = function (no) {
    ...
    $("#detailLayer").load(YHu.util.ctxPath('/referral/queryReferralComment'), {recordId : referralValue},function () {
