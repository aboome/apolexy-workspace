    ...
    YHu.util={
        ...
        bankAuthorize : function(callback){
        	...
        	var checkPw = function(i) {
				...
				var postdata ={ bocPw : boc_pw ,bocUserName:bocNo, jsebPw : jseb_pw,jsebUserName:jsebNo };
				$.post(YHu.util.ctxPath("/checkBankPw"),postdata,function(result){
					YHu.ui.closeLoading();
					if(!result.success){
        ...
        imageUpload : function(imageElementId,postUrl,callback){
            ...
            if ($("#"+imageElementId).val() == "undefine" || $("#"+imageElementId).val() == ""){
                callback("");
                return;
            }
