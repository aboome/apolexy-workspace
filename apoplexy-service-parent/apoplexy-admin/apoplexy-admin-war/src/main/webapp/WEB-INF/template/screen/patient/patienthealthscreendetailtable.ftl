...
<ul>
	<#list healthScreenDetailList as detail>
	<li class="clearfix">
		<p class="pull-left font-size-14 col-xs-10" style="padding-bottom: 10px;" id="question${detail_index}">${detail.detailIndex}.${detail.question}</p>
