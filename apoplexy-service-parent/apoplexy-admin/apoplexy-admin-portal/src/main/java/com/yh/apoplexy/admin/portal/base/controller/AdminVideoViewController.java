...
public class AdminVideoViewController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AdminVideoViewController.class);

	@Autowired
	private MongoDbManager mongoDbManager;

	@RequestMapping(value = "/admin/video/view/{videoId}", method = RequestMethod.GET)
