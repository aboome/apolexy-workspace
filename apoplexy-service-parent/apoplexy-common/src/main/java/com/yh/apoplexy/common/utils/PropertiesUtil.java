...
import com.yh.apoplexy.common.constants.MessagePropertiesConstants;
...
public class PropertiesUtil {
    ...
    private static ResourceBundle APP_MESSAGE_RES = ResourceBundle.getBundle(MessagePropertiesConstants.APPLICATION_MESSAGE_CONFIG);
    ...
    public static ResourceBundle getResourceBundle(String resourceBundle) {
        if (PropertiesConstants.APPLICATION_ENV_CONFIG.equals(resourceBundle)) {
            return APP_ENV_RES;
        } else if (MessagePropertiesConstants.APPLICATION_MESSAGE_CONFIG.equals(resourceBundle)) {
            return APP_MESSAGE_RES;
        } else {
