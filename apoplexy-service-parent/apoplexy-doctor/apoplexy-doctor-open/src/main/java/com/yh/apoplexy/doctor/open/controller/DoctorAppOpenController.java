 ...
 */
@Controller
public class DoctorAppOpenController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DoctorAppOpenController.class);

    @Autowired
    private DoctorAppOpenService doctorAppOpenService;
    ...
    public void appOpenApi(HttpServletRequest request, HttpServletResponse response) {
        ...
        // 处理器执行业务
        String responseString = doctorAppOpenService.proxy(requestString, serviceKey);
