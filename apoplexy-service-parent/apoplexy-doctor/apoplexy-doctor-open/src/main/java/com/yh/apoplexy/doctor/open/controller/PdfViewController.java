...
public class PdfViewController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(PdfViewController.class);

	@Autowired
	private MongoDbManager mongoDbManager;

	@RequestMapping(value = "/app/pdf/view/{pdfId}", method = RequestMethod.GET)
	public void viewIamge(HttpServletRequest request, HttpServletResponse response, @PathVariable(value="pdfId") String pdfId) {
