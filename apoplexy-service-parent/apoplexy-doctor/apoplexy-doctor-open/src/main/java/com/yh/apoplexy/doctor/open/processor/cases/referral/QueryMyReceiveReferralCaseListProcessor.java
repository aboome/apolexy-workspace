...
import com.yh.apoplexy.doctor.open.request.cases.referral.QueryMyReceiveReferralCaseListRequest;
import com.yh.apoplexy.doctor.open.response.base.DoctorAppBaseResponse;
import com.yh.apoplexy.doctor.open.response.cases.referral.QueryMyReceiveReferralCaseListResponse;
...
/**
 * 我的-我的接诊列表(doc-0030)处理类
 * Created by wunder on 16/9/10 10:50.
 */
public class QueryMyReceiveReferralCaseListProcessor extends DoctorAppBaseServiceProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryMyReceiveReferralCaseListProcessor.class);
    ...
    protected DoctorAppBaseResponse doProcess(DoctorAppBaseRequest requestObject) {
        ...
        QueryMyReceiveReferralCaseListResponse queryMyReceiveReferralCaseListResponse = new QueryMyReceiveReferralCaseListResponse();
        ...
        QueryMyReceiveReferralCaseListRequest queryMyReceiveReferralCaseListRequest = JSONObject.parseObject(requestObject.getParameter().toString(), QueryMyReceiveReferralCaseListRequest.class);

        if (null == queryMyReceiveReferralCaseListRequest) {
        ...
        Result validateResult = CommonValidator.validate(queryMyReceiveReferralCaseListRequest);
        ...
        Long userId = Long.parseLong(queryMyReceiveReferralCaseListRequest.getUserId());

        String status = queryMyReceiveReferralCaseListRequest.getStatus();

        int currPage = Integer.parseInt(queryMyReceiveReferralCaseListRequest.getCurPage());

        int pageSize = Integer.parseInt(queryMyReceiveReferralCaseListRequest.getPageSize());
        ...
        queryReferralCaseDto.setReceiveStatus(status);

        List<ReferralCaseInfoDto> referralCaseInfoDtoList = referralCaseService.queryMyReceiveListByPage(queryReferralCaseDto, page);
        ...
        if (CollectionUtils.isEmpty(referralCaseInfoDtoList)) {
            ...
            queryMyReceiveReferralCaseListResponse.setList(referralCaseItemList);
            queryMyReceiveReferralCaseListResponse.setCurPage(String.valueOf(page.getCurrentPage()));
            queryMyReceiveReferralCaseListResponse.setPageSize(String.valueOf(page.getPageSize()));
            queryMyReceiveReferralCaseListResponse.setTotalCount(String.valueOf(page.getCount()));
        ...
        response.setParameter(queryMyReceiveReferralCaseListResponse);
