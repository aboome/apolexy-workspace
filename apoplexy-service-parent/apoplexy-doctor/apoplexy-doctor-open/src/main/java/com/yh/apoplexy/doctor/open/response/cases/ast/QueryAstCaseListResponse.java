...
/**
 * 查询AST病例列表(doc-0034)响应
 * Created by wunder on 16/9/2 08:52.
 */
public class QueryAstCaseListResponse implements Serializable {

    private static final long serialVersionUID = -7072807159166436448L;
