...
import com.yh.apoplexy.doctor.open.request.cases.referral.QueryReceivedReferralCaseListRequest;
import com.yh.apoplexy.doctor.open.response.base.DoctorAppBaseResponse;
import com.yh.apoplexy.doctor.open.response.cases.referral.QueryReceivedReferralCaseListResponse;
 ...
 * Created by wunder on 16/9/10 10:37.
 */
public class QueryReceivedReferralCaseListProcessor extends DoctorAppBaseServiceProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryReceivedReferralCaseListProcessor.class);
    ...
    protected DoctorAppBaseResponse doProcess(DoctorAppBaseRequest requestObject) {
        ...
        QueryReceivedReferralCaseListResponse queryReceivedReferralCaseListResponse = new QueryReceivedReferralCaseListResponse();
        ...
        QueryReceivedReferralCaseListRequest queryReceivedReferralCaseListRequest = JSONObject.parseObject(requestObject.getParameter().toString(), QueryReceivedReferralCaseListRequest.class);

        if (null == queryReceivedReferralCaseListRequest) {
        ...
        Result validateResult = CommonValidator.validate(queryReceivedReferralCaseListRequest);
        ...
        Long userId = Long.parseLong(queryReceivedReferralCaseListRequest.getUserId());

        int currPage = Integer.parseInt(queryReceivedReferralCaseListRequest.getCurPage());

        int pageSize = Integer.parseInt(queryReceivedReferralCaseListRequest.getPageSize());
        ...
        List<ReferralCaseInfoDto> referralCaseInfoDtoList = referralCaseService.queryReceivedListByPage(queryReferralCaseDto, page);
        ...
        if (CollectionUtils.isEmpty(referralCaseInfoDtoList)) {
            ...
            queryReceivedReferralCaseListResponse.setList(referralCaseItemList);
            queryReceivedReferralCaseListResponse.setCurPage(String.valueOf(page.getCurrentPage()));
            queryReceivedReferralCaseListResponse.setPageSize(String.valueOf(page.getPageSize()));
            queryReceivedReferralCaseListResponse.setTotalCount(String.valueOf(page.getCount()));
        ...
        for (ReferralCaseInfoDto referralCaseInfoDto : referralCaseInfoDtoList) {
            ...
            referralCaseItem.setDoctorStarLevel(String.valueOf(referralCaseInfoDto.getDoctorStarLevel()));
        ...
        response.setParameter(queryReceivedReferralCaseListResponse);
