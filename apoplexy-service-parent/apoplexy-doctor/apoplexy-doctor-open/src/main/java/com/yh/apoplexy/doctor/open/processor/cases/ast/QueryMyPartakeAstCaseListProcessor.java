...
import com.yh.apoplexy.doctor.open.request.cases.ast.QueryMyPartakeAstCaseListRequest;
import com.yh.apoplexy.doctor.open.response.base.DoctorAppBaseResponse;
import com.yh.apoplexy.doctor.open.response.cases.ast.QueryMyPartakeAstCaseListResponse;
...
/**
 * 我的-我参与的列表(doc-0045)处理类
 * Created by wunder on 16/9/11 12:10.
 */
public class QueryMyPartakeAstCaseListProcessor extends DoctorAppBaseServiceProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryMyPartakeAstCaseListProcessor.class);
    ...
    protected DoctorAppBaseResponse doProcess(DoctorAppBaseRequest requestObject) {
        ...
        QueryMyPartakeAstCaseListResponse queryMyPartakeAstCaseListResponse = new QueryMyPartakeAstCaseListResponse();
        ...
        QueryMyPartakeAstCaseListRequest queryMyPartakeAstCaseListRequest = JSONObject.parseObject(requestObject.getParameter().toString(),QueryMyPartakeAstCaseListRequest.class);

        if (null == queryMyPartakeAstCaseListRequest) {
        ...
        Result validateResult = CommonValidator.validate(queryMyPartakeAstCaseListRequest);
        ...
        Long userId = Long.parseLong(queryMyPartakeAstCaseListRequest.getUserId());

        int currPage = Integer.parseInt(queryMyPartakeAstCaseListRequest.getCurPage());

        int pageSize = Integer.parseInt(queryMyPartakeAstCaseListRequest.getPageSize());
        ...
        List<AstCaseInfoDto> astCaseInfoDtoList = astCaseService.queryMyPartakeListByPage(queryAstCaseDto,page);
        ...
        if (CollectionUtils.isEmpty(astCaseInfoDtoList)){
            ...
            queryMyPartakeAstCaseListResponse.setList(astCaseItemList);
            queryMyPartakeAstCaseListResponse.setCurPage(String.valueOf(page.getCurrentPage()));
            queryMyPartakeAstCaseListResponse.setPageSize(String.valueOf(page.getPageSize()));
            queryMyPartakeAstCaseListResponse.setTotalCount(String.valueOf(page.getCount()));

            response.setParameter(queryMyPartakeAstCaseListResponse);
            return response;
