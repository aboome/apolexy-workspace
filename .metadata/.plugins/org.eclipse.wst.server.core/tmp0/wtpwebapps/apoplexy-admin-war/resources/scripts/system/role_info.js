...
var queryRoleInfoList = function () {
    ...
    YHu.ui.tableLoad("#adminroleinfotable", url, queryRoleInfoCondition);
...
var updateRoleMenu = function (no) {
    ...
    $.get(YHu.util.ctxPath('/roleInfo/queryMenuList/' + id), function (result) {
    ...
    layer.open({
        ...
        yes: function () {
            ...
            YHu.ui.loading();
            var handleRequest = $.post(YHu.util.ctxPath('/roleInfo/updateRoleMenu'), roleMenuInfo);
            handleRequest.done(function (jsonResult) {
                YHu.ui.closeLoading();
                if (jsonResult.success) {
                    YHu.ui.closeAllLayer();
