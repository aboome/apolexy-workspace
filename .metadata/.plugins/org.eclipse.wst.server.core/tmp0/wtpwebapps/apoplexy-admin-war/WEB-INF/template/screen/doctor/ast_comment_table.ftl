...
<div class="discusslist">
    <table class="table table-hover table-bordered table-striped my-table-layer">
        ...
        <tr>
            ...
            <td>
                <a href="javascript:;" class="hospital-delete" onclick="deleteComment(${comment_index})"><i
            ...
            <tr>
                ...
                <td>
                    <a href="javascript:;" class="hospital-delete" onclick="deleteChildComment(${childComment_index})"><i
                            class="glyphicon glyphicon-trash"></i> 删除</a>
                </td>
            </tr>
            </#list>
