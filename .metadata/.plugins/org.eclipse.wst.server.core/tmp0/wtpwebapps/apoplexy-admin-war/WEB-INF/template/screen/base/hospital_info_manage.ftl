...
<div class="hospital-wrap">
    ...
    <div class="table-content">
        <div class="add-and-import">
            ...
            <button typee="button" class="btn download"><a href="${ctx}/resources/template/hospital.xlsx"><i class="fa fa-download"></i>模板下载</a></button>
    ...
    <div id="modifyLayer" style="display:none" class="zf-modal">
        ...
        <form class="form-horizontal" id="modifyHospitalInfo" role="form">
            ...
            <div class="form-group">
                <label for="modifyHospitalImage" class="control-label col-xs-3">医院图片</label>
                <div class="col-xs-9">
